            ...
            <div class="row h-100 min-vh-100">
                <div class="col-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form class="table-responsive col-lg-10" role="form" method="POST" action="update-parent.php">
                                <div class="mt-1">
                                                ...
                                                <div class="col-lg-5">
                                                    ...
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio"
                                                            ...
                                                            value="Yes, because its my job to achieve this result"
                                                            id="flexRadioDefault8">
                                                        <label class="form-check-label" for="flexRadioDefault8">
                                                            Yes, because its my job to achieve this result
                                                        </label>
                                                    </div>
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio"
                                            ...
                                            <div class="col-lg-10 m-1">
                                                ...
                                                <div class="form-check form-check-inline">
                                                    ...
                                                    <label class="form-check-label" for="flexRadioDefault22">
                                                        Its a very interesting aspect of the teaching profession for
                                                        you
                                                    </label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    ...
                                                    <label class="form-check-label" for="flexRadioDefault23">
                                                        You dont worry about it and work with the high-level students;
                                            ...
                                            <div class="col-lg-10 m-1">
                                                ...
                                                <div class="form-floating">
                                                    <textarea class="form-control" placeholder="Leave a comment here"
                                                        name="salaryexpectation" value="<?= $row['salaryexpectation'] ?>"></textarea>
