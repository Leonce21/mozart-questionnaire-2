            ...
            <div class="row h-100 min-vh-100">
                <div class="col-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form class="table-responsive col-lg-10" role="form" method="POST" action="academic.php">
                                <div class="mt-1">
                                    ...
                                    <div mat-dialog-content class="ms-5">
                                        ...
                                        <ol class="list-group list-numbered">
                                            ...
                                            <div class="col-lg-10 m-1">
                                                ...
                                                <div class="form-check form-check-inline">
                                                    ...
                                                    <label class="form-check-label" for="flexRadioDefault1">
                                                        No, because a student can succeed very well without academic
                                                        support
                                                    </label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                            ...
                                            <div class="col-lg-10 m-1">
                                                ...
                                                <div class="form-check form-check-inline">
                                                    ...
                                                    <label class="form-check-label" for="flexRadioDefault4">
                                                        Academic support is assistance to complement the work done in
                                            ...
                                            <!--  Question 3  -->
                                            <div class="col-lg-10 m-1">
                                                <li for="" class="form-label list-item">A child that you are tutoring in
                                                    a subject must absolutely succeed in it?</li>
                                                <div class="col-lg-5">
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio"
                                                            formControlName="Q3" name="Q3" value="Not necessarily"
                                            ...
                                            <div class="col-lg-10 m-1">
                                                <li for="" class="form-label list-item">You are not at all inspired on a
                                                    question raised by a student you are mentoring, what do you do?
                                                </li>
                                                <div class="col-lg-10">
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio"
                                                            formControlName="Q4" name="Q4"
                                                            value="You refer the question back to the student while you gather your thoughts"
                                                            id="flexRadioDefault10">
                                                        <label class="form-check-label" for="flexRadioDefault10">
                                                            You refer the question back to the student while you gather
                                                            your thoughts
                                                        </label>
                                                    </div>
                                                    <div class="form-check form-check-inline">
                                                        ...
                                                        <label class="form-check-label" for="flexRadioDefault11">
                                                            You postpone the question to the next session, to buy some
                                                            time
                                                        </label>
                                                    </div>
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio"
                                                            formControlName="Q4" name="Q4"
                                                            value="You still attempt to provide explanations, even if they are shallow, while you try to find the real inspiration.3"
                                            ...
                                            <!--  Question 5  -->
                                            <div class="col-lg-10 m-1">
                                                <li for="" class="form-label list-item">A not very bright student
                                                    complains about your teaching methods</li>
                                                <div class="col-lg-11">
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio"
                                                            formControlName="Q5" name="Q5"
                                                    ...
                                                    <div class="form-check form-check-inline">
                                                        ...
                                                        <label class="form-check-label" for="flexRadioDefault15">
                                                            ...
                                                            your techniques and methods, and you can boast of the
                                                            evidence through previous results
                                                        </label>
                                                    </div>
                                            ...
                                            <div class="col-lg-10 m-1">
                                                ...
                                                <div class="form-check form-check-inline">
                                                    ...
                                                    <label class="form-check-label" for="flexRadioDefault17">
                                                        You try to find out why this student keeps repeating this
                                                        behavior and address his parents about this attitude
                                                    </label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" formControlName="Q6"
                                                    ...
                                                    <label class="form-check-label" for="flexRadioDefault18">
                                                        You give him yet another lecture about his behavior before
                                                        moving on to the lesson of the day.
                                                    </label>
                                                </div>
                                            </div>
                                            <!--  Question 7  -->
                                            <div class="col-lg-10 m-1">
                                                <li for="" class="form-label list-item">You have a very heterogeneous
                                                    group (content of the lessons) in your class. </li>
                                                <div class="col-lg-7">
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio"
                                                            formControlName="Q7" name="Q7"
                                                    ...
                                                    <div class="form-check form-check-inline">
                                                        ...
                                                        <label class="form-check-label" for="flexRadioDefault21">
                                                            You work with everyone on the most advanced lesson; anyway,
                                                            the others will tackle it later
                                                        </label>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-lg-10 m-1">
                                                <li for="" class="form-label list-item">You have a very heterogeneous
                                                    group (student levels) in your class. </li>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" formControlName="Q8"
                                                        name="Q8"
                                                        value="It's a very interesting aspect of the teaching profession for you"
                                                        id="flexRadioDefault22">
                                                    <label class="form-check-label" for="flexRadioDefault22">
                                                        It's a very interesting aspect of the teaching profession for
                                                        you
                                                    </label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    ...
                                                    <label class="form-check-label" for="flexRadioDefault23">
                                                        You don't worry about it and work with the high-level students;
                                                ...
                                                <div class="form-check form-check-inline">
                                                    ...
                                                    <label class="form-check-label" for="flexRadioDefault24">
                                                        You find it challenging and try to seek help from your
                                                        colleagues.
                                                    </label>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-10 m-1">
                                                ...
                                                <div class="col-lg-7">
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio"
                                                            formControlName="Q9" name="Q9"
                                                            value="Your consistently positive past results"
                                            ...
                                            <!--  Question 10  -->
                                            <div class="col-lg-10 m-1">
                                                <li for="" class="form-label list-item">A brilliant student claims that
                                                    you made a mistake in an exercise (wrongly) because he has a
                                                    different correction (probably wrong). </li>
                                                <div class="form-check form-check-inline">
                                                ...
                                                <div class="form-check form-check-inline">
                                                    ...
                                                    <label class="form-check-label" for="flexRadioDefault30">
                                                        You tell him that you are certain that your solution is correct,
                                                        and he would be better off accepting it.
                                                    </label>
                                                </div>
                                            </div>
